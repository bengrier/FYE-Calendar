...
window.CalData = (function () {
  ...
  var EVENTS = [
    { id: "shop", date: "2026-04-06", start: 16, time: "4:00 – 6:00 pm", title: "Machine Shop Safety Certification", org: "Engineering Manufacturing Lab", place: "Manufacturing Lab 12", flyer: null,
    ...
    { id: "boeing", date: "2026-04-09", start: 17.5, time: "5:30 – 7:00 pm", title: "Boeing Information Session", org: "Career Services", place: "Scott 229", flyer: null,
    ...
    { id: "aero-14", date: "2026-04-14", start: 14, time: "2:00 – 4:00 pm", title: "Design-Build-Fly Weekly Build", org: "AIAA · Ram Aero", place: "Magellan Room", flyer: "aiaa",
    ...
    { id: "cookie-17", date: "2026-04-17", start: 11, time: "11:00 am – 2:00 pm", title: "Free Cookie Friday", org: "Engineering Community", place: "AV Kitchen", flyer: "cookie",
    ...
    { id: "aero-21", date: "2026-04-21", start: 14, time: "2:00 – 4:00 pm", title: "Design-Build-Fly Weekly Build", org: "AIAA · Ram Aero", place: "Magellan Room", flyer: "aiaa",
      blurb: "Ram Aero's open build session for the AIAA Design-Build-Fly competition aircraft. First years welcome with no experience — you will be handed a task.", tags: ["Mechanical", "Club"] },
    { id: "fairprep", date: "2026-04-22", start: 15, time: "3:00 – 5:00 pm", title: "Career Fair Prep Drop-In", org: "Career Services", place: "Lory Student Center 224", flyer: null,
    ...
    { id: "cookie-24", date: "2026-04-24", start: 11, time: "11:00 am – 2:00 pm", title: "Free Cookie Friday", org: "Engineering Community", place: "AV Kitchen", flyer: "cookie",
      blurb: "Cookies, and the people who show up for cookies. The easiest way to meet a club without committing to one.", tags: ["All disciplines", "Social", "Free food"] },

    { id: "swe", date: "2026-04-27", start: 16, time: "4:00 – 5:30 pm", title: "Résumé Lab for First Years", org: "Society of Women Engineers", place: "Engineering B203", flyer: null,
    ...
    { id: "aiaa", date: "2026-04-28", start: 14, time: "2:00 – 4:00 pm", title: "Design-Build-Fly Weekly Build", org: "AIAA · Ram Aero", place: "Magellan Room", flyer: "aiaa",
      blurb: "Ram Aero's open build session for the AIAA Design-Build-Fly competition aircraft. First years welcome with no experience — you will be handed a task.", tags: ["Mechanical", "Club"] },
    { id: "peru", date: "2026-04-29", start: 12, time: "12:00 – 1:00 pm", title: "Grand Challenges in Peru: Info Session", org: "International Programs", place: "Scott 108", flyer: "peru",
      blurb: "A winter-break community service project in Lima and Lobitos investigating sustainable engineering on the coast. Early application deadline May 1.", tags: ["Civil", "Workshop"] },
    { id: "git", date: "2026-04-29", start: 18, time: "6:00 – 7:30 pm", title: "Git Night: Stop Emailing Yourself Zips", org: "Computer Science Club", place: "Computer Science 130", flyer: null,
    ...
    { id: "ispe", date: "2026-04-30", start: 17, time: "5:00 – 6:00 pm", title: "Corden Pharma Industry Night", org: "ISPE Student Chapter", place: "Scott 229", flyer: "ispe",
    ...
    { id: "solder", date: "2026-04-30", start: 17.5, time: "5:30 – 7:00 pm", title: "Soldering 101", org: "IEEE Student Branch", place: "Engineering E101 Lab", flyer: null,
    ...
    { id: "cookie", date: "2026-05-01", start: 11, time: "11:00 am – 2:00 pm", title: "Free Cookie Friday", org: "Engineering Community", place: "AV Kitchen", flyer: "cookie",
      blurb: "Cookies, and the people who show up for cookies. The easiest way to meet a club without committing to one.", tags: ["All disciplines", "Social", "Free food"] },
    { id: "ewb", date: "2026-05-01", start: 15, time: "3:00 – 4:00 pm", title: "Engineers Without Borders: General Meeting", org: "EWB–CSU", place: "Scott 214", flyer: null,
    ...
    { id: "racing", date: "2026-05-02", start: 10, time: "10:00 am – 2:00 pm", title: "Ram Racing Open Garage", org: "Formula SAE", place: "Powerhouse Bay 3", flyer: null,
    ...
    { id: "studyhall", date: "2026-05-03", start: 18, time: "6:00 – 9:00 pm", title: "First-Year Study Hall", org: "Common First Year", place: "Morgan Library, 2nd floor", flyer: null,
    ...
    { id: "major", date: "2026-05-04", start: 17, time: "5:00 – 7:00 pm", title: "Major Declaration Ceremony", org: "Engineering Common First Year", place: "LSC Theatre", flyer: "major",
    ...
    { id: "canoe", date: "2026-05-06", start: 12, time: "12:00 – 1:00 pm", title: "Concrete Canoe Send-Off", org: "ASCE Student Chapter", place: "Engineering Quad", flyer: null,
    ...
    { id: "cookie-08", date: "2026-05-08", start: 11, time: "11:00 am – 2:00 pm", title: "Free Cookie Friday", org: "Engineering Community", place: "AV Kitchen", flyer: "cookie",
      blurb: "Cookies, and the people who show up for cookies. The easiest way to meet a club without committing to one.", tags: ["All disciplines", "Social", "Free food"] },
    { id: "aero-12", date: "2026-05-12", start: 14, time: "2:00 – 4:00 pm", title: "Design-Build-Fly Weekly Build", org: "AIAA · Ram Aero", place: "Magellan Room", flyer: "aiaa",
      blurb: "Ram Aero's open build session for the AIAA Design-Build-Fly competition aircraft. First years welcome with no experience — you will be handed a task.", tags: ["Mechanical", "Club"] },
    { id: "showcase", date: "2026-05-14", start: 13, time: "1:00 – 4:00 pm", title: "Summer Research Showcase", org: "Undergraduate Research Office", place: "Engineering Atrium", flyer: null,
    ...
    { id: "cookie-15", date: "2026-05-15", start: 11, time: "11:00 am – 2:00 pm", title: "Last Cookie Friday of the Year", org: "Engineering Community", place: "AV Kitchen", flyer: "cookie",
  ...
  var CUSTOM_BY_EVENT = {
    ...
    "aero-14": ["Design-Build-Fly", "Hands-on build"],
    "aero-21": ["Design-Build-Fly", "Hands-on build"],
    "aero-12": ["Design-Build-Fly", "Hands-on build"],
    ...
    "cookie-17": ["First years welcome"],
    "cookie-24": ["First years welcome"],
    "cookie-08": ["First years welcome"],
    "cookie-15": ["First years welcome"],
  ...
  var PENDING = [
    { id: "p1", title: "Robotics Club: Line-Follower Sprint", org: "RamBotics", when: "Thu May 7, 6:00 – 9:00 pm", place: "Engineering E205", submitted: "2 days ago",
      by: "Priya Raman", email: "praman@rams.colostate.edu", repeat: "Does not repeat", flyer: "line-follower-sprint.pdf",
      ...
      tags: ["Electrical", "Club", "Free food", "Evening"], newTags: ["Beginner kits provided"] },
    { id: "p2", title: "Women in Computing Coffee Hour", org: "ACM-W", when: "Wed May 6, 9:30 – 10:30 am", place: "Computer Science Atrium", submitted: "yesterday",
      by: "Dana Whitfield", email: "dwhitfield@colostate.edu", repeat: "Every other week until Dec 16, 2026", flyer: null,
      ...
      tags: ["Computer Science", "Club", "Free food", "Morning"], newTags: ["First years welcome", "Recurring drop-in"] }
  ];
